...
<div id="nav" class="clearfix">
	...
	<c:choose>
		<c:when test="${param.path eq 'mybook'}">
			<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/my/reviews/${nickname }">"${nickname }"님의 서평</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath}/taste">취향저격</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath}/my/playlists/${nickname }">플레이리스트</a></li>			
			<li role="presentation"><a href="${pageContext.request.contextPath}/analyze">통계</a></li>
		</c:when>
		<c:when test="${param.path eq 'taste'}">
			<li role="presentation"><a href="${pageContext.request.contextPath}/my/reviews/${nickname }">"${nickname }"님의 서평</a></li>
		...
		<c:when test="${param.path eq 'playlist'}">
			<li role="presentation"><a href="${pageContext.request.contextPath}/my/reviews/${nickname }">"${nickname }"님의 서평</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath}/taste">취향저격</a></li>
			<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/my/playlists/${nickname }">플레이리스트</a></li>
			<li role="presentation"><a href="${pageContext.request.contextPath}/analyze">통계</a></li>
		</c:when>
